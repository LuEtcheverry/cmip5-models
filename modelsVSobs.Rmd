...
Next, we read in the data. Note I have already uploaded the CMIP5 ensemble data to this GitHub repository, since that saves you from having to go through the [Climate Explorer](http://climexp.knmi.nl/) interface.[^1] The HadCRUT4 data, on the other hand, is already in a convenient form and so we'll download this data directly from the Met Office website. 
...
# points(cmip5_trend_summ$Length, cmip5_trend_summ$Trend.mean, pch = 19)
# lines(cmip5_trend_summ$Length, cmip5_trend_summ$Trend_025, lwd = 1.5, lty = 3)
# lines(cmip5_trend_summ$Length, cmip5_trend_summ$Trend_05, lwd = 1.5, lty = 1)
# lines(cmip5_trend_summ$Length, cmip5_trend_summ$Trend_95, lwd = 1.5, lty = 1)
# lines(cmip5_trend_summ$Length, cmip5_trend_summ$Trend_975, lwd = 1.5, lty = 3)
# lines(had_trend$Length, had_trend$Trend, col = "limegreen", lwd = 2, lty = 1)
# points(had_trend$Length, had_trend$Trend, col = "limegreen", pch = 19)
# legend("topleft", 
...
# lines(had_trend$Length, had_05_line, col = "gold", lwd=2, lty = 1)
# lines(had_trend$Length, had_025_line, col = "red", lwd = 2, lty = 1)
# points(had_trend$Length, had_trend$Trend, col = had.col, pch = 19)
par(las = 1) # Rotate y-axis labels sideways
plot(cmip5_trend_summ$Length, cmip5_trend_summ$Trend.mean,
     type="l", lwd = 1.5,
     main = "", 

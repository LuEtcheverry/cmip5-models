...
![](modelsVSobs_files/figure-html/unnamed-chunk-8-1.png) ![](modelsVSobs_files/figure-html/unnamed-chunk-8-2.png) 

Note: To obtain these last two figures, all you need to do is assign a new end year as the fixed point for all of the regressions (e.g.`end_year <- 2005`), but otherwise keep the code exactly the same.
